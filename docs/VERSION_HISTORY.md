...
**Design documents**:
- `docs/FABLE_REVIEW.md` - AI review's in-depth review
- `docs/PROJECT_BACKGROUND.md` - Project background (original user requirements)

**Reason for improvement**:
- AI review review identified "missing write review mechanism" as a fatal flaw
...
|----------|-------------|
| `docs/archive/FABLE_REVIEW.md` | AI review's in-depth review |
| `docs/PROJECT_BACKGROUND.md` | Project background |
