...
**文件**: `.claude/skills/evolution/evolution-export.py` | **来源**: design-opus
...
**文件**: `docsV3/EXPORT_AND_ANALYSIS_DESIGN.md` | **来源**: design-opus
...
**文件**: `.claude/skills/evolution/rules/write.md` | **来源**: design-opus
...
**文件**: `.claude/skills/evolution/commands/sync.md` | **来源**: design-opus
...
**文件**: `<project-root>\.claude\skills\evolution\evolution-export.py` | **来源**: code-fable
...
**文件**: `.claude/skills/evolution/evolution-export.py` | **来源**: data-opus
...
**文件**: `.claude/skills/evolution/commands/init.md` | **来源**: data-opus
...
**文件**: `<project-root>\.claude\skills\evolution\evolution-export.py` | **来源**: ux-fable
...
**文件**: `<project-root>\.claude\skills\evolution\commands\init.md` | **来源**: ux-fable
...
**文件**: `<project-root>\evolution\knowledge-base\kb-index.md` | **来源**: ux-fable
...
**文件**: `<project-root>\.claude\skills\evolution\commands\sync.md` | **来源**: ux-fable
...
**文件**: `docsV3/INSTALLATION_GUIDE.md` | **来源**: docs-fable
...
**文件**: `docsV3/EVOLUTION_RULES_AND_LOGIC_V3.md` | **来源**: docs-fable
...
**文件**: `docsV3/EXPORT_AND_ANALYSIS_DESIGN.md` | **来源**: docs-fable
...
**文件**: `docsV3/PROJECT_BACKGROUND.md` | **来源**: docs-fable
...
**文件**: `.claude/skills/evolution/evolution-export.py` | **来源**: evolution-opus
...
**文件**: `.claude/skills/evolution/.claude/skills/evolution/rules/write.md` | **来源**: evolution-opus
...
**文件**: `.claude/skills/evolution/.claude/skills/evolution/commands/sync.md` | **来源**: evolution-opus
...
**文件**: `.claude/skills/evolution/.claude/skills/evolution/rules/dedup.md` | **来源**: evolution-opus
...
**文件**: `.claude/skills/evolution/.claude/skills/evolution/SKILL.md` | **来源**: evolution-opus
